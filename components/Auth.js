export default function Auth({ authenticate }) {
  ...
  return (
    <div className="w-screen h-screen flex flex-col justify-center items-center bg-gradient-to-r from-green to-purple">
      ...
      <button
        className="flex items-center justify-center bg-blue text-white px-2 py-1 mt-3 md:text-xl lg:text-3xl hover:bg-darkBlue drop-shadow-xl hover:drop-shadow-2xl transition duration-150 ease-out"
        onClick={phantomAuth}
      >
        <img
